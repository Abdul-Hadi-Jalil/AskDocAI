...
class MainTopicsSection extends StatelessWidget {
  final String content;

  const MainTopicsSection({super.key, required this.content});

  @override
  Widget build(BuildContext context) {
    final topics = _extractBulletPoints(content);
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          ...topics.map((topic) => TopicItem(title: topic)),
        ],
      ),
    );
  }
